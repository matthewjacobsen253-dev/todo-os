  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
            ...
            <div className="flex-1 max-w-md mx-auto px-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-muted border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition text-sm"
                />
              </div>
            </div>
        ...
        <button className="fixed bottom-8 right-8 md:bottom-10 md:right-10 w-14 h-14 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition flex items-center justify-center group">
